...
```cmd
ssh -i C:\Users\ASUS\Downloads\你的密钥文件.pem root@47.110.127.87
```
...
```cmd
# 如果使用密钥文件
scp -i C:\Users\ASUS\Downloads\你的密钥文件.pem "C:\Users\ASUS\Downloads\pack_project (3).tar.gz" root@47.110.127.87:/tmp/
...
DATABASE_URL=postgresql://用户名:密码@rm-xxxxxx.pg.rds.aliyuncs.com:1921/数据库名
```
